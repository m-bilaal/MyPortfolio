        ...
        <div className="container">
          <div className="headerWrapper">
            ...
            <div className="headerLogos">
              <a href="https://www.linkedin.com/in/muhammad-bilal-58319325b/">
                <img src={linkedinLogo} alt="Linkedin" />
              </a>
              <a href="https://github.com/m-bilaal">
      ...
      <section id="home" class="homeSec">
        <div class="container">
          <div class="homeWrapper">
            <div class="homeText">
              <h1>
                Hi, I'm <span>Muhammad Bilal</span>
              </h1>
              <h2>Front-End Developer</h2>
              <p>
                I'm a Front-End Developer with a Bachelors degree from NUST
                Islamabad, looking to make a position for myself in the
          ...
          <div class="educationWrapper">
            ...
            <div className="educationMainCard">
              <Educationcard
                ...
                institution={
                  "NUST Institute of Civil Engineering (NICE-NUST), Islamabad"
                }
                date={"September 2019 - June 2023"}
              />
              <Educationcard
                qualification={"FSc (Pre-Engineering)"}
                institution={"Army Burn Hall College for Boys, Abbottabad"}
            ...
            <div className="skillsMainCard">
              <div className="skillsTechnicalMainCard">
                ...
                <div className="skillsTechnicalCard">
                  ...
                  <Skillscontentcard skill={"PHP"} percentage={"70%"} />
                  <Skillscontentcard
                  ...
                  <Skillscontentcard skill={"Google Ads"} percentage={"95%"} />
                  <Skillscontentcard skill={"Meta Ads"} percentage={"95%"} />
                </div>
              </div>
              <div className="skillsSoftMainCard">
                ...
                <div className="skillsSoftCard">
                  <Skillscontentcard
                    ...
                    percentage={"95%"}
                  />
                  <Skillscontentcard skill={"Leadership"} percentage={"85%"} />
